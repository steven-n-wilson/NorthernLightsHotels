CREATE DATABASE hotel_assignment_test;

\c hotel_assignment_test
...
INSERT INTO employee(first_name,last_name, emp_role, hotel_id,street,city, state_or_province,postal_code)
VALUES
...
INSERT INTO hotel_chain(name,office_address,number_of_hotels,phone_number,email_address)
VALUES
	('Wilson Hotels','{"420","Opus Avenue","Unit 5","Ottawa","Ontario","K9F 8U9"}', '9','18002572001','hotels@wilson.com'),
    ('Goodnite Hostels','{"9500","Moon Parkway","Unit 7","Baltimore","Maryland","20700"}', '10','1800700100','hostels@goodnite.com'),
	('Bugsfree Inn','{"7400","Flea Road","Unit 3","Calgary","Alberta","V1K 3L3"}','9','1800100200','inn@bugsfree.com'),
	('Southern BnB','{"9800","Hospitality Road","Unit 9","Dallas","Texas","75500"}','9','1800152222','bnb@southern.com'),
	('Truenorth Lodge','{"700","Igloo Street","Unit 2","Edmonton","Alberta","C1A 5G1"}','8','1800350855','lodge@truenorth.com');

--INSERT INTO employee(hotel_id,first_name,last_name,emp_role,street,city,state_or_province,country,postal_code)

INSERT INTO hotel_addresses(hotel_id,street,city,state_or_province,country,postal_code)
VALUES
	(2293202,'7028 Riverside Drive','Ottawa','Ontario','Canada','K7C 0E1'),
	(4119615,'500 Opus Avenue','Ottawa','Ontario','Canada','K9F 8V1'),
	(8170894,'4837 Selah Way','Burlington','Vermont','USA','03755'),
	(1103371,'52 Myrtle Lane','Toronto','Ontario','Canada','M4W 0R7'),
	(6768926,'154 Lookout Drive','Vancouver','British Columbia','Canada','V5K 1P3'),
	(6809581,'724 Riverview Street','Montreal','Quebec','Canada','H2Y 1W7'),
	(5986244,'2 Harrison Street','Vancouver','British Columbia','Canada','V5K 1W5'),
	(3410170,'9676 Randall Mill Road','Winnipeg','Manitoba','Canada','R2C 1R2'),
	(4334270,'67 Bridgeway Avenue','Montreal','Quebec','Canada','H1Z 1J2'),
	...
	(3367760,'7896 Parker Way','Kelowna','British Columbia','Canada','Y2K 2U9'),
	(3295605,'7450 Flea Road','Calgary','Alberta','Canada','C1A 5F9'),
	(6885722,'3812 Cockroach Way','Calgary','Alberta','Canada','C2B 4I8'),
	(8927171,'1100 Condor Street','Saskatoon','Saskatchewan','Canada','F2R 7B4'),
	(5057696,'2525 Eagleview Avenue','Regina','Saskatchewan','Canada','G81 3H0'),
	(1791025,'2900 Younge Street','Toronto','Ontario','Canada','M8Y 1G9'),
	...
	(1669786,'210 Lobster Road','Halifax','Nova Scotia','Canada','J1J 4K1'),
	...
	(3371676,'750 Igloo Street','Edmonton','Alberta','Canada','C1A 5F9'),
	(8926680,'400 Duplessis Street','Quebec City','Quebec','Canada','G1T 5L1'),
	(9581598,'150 Manitou Road','Iqaluit','Nunavut','Canada','X1D 5D2'),
	(6244341,'78 Radisson Avenue','Edmonton','Alberta','Canada','C5G 9X3'),
	(3170033,'202 Caribou Road','Yellowknife','Northwest Territories','Canada','Y7A 2Q4'),
	(4270962,'397 Via Borealis','Whitehorse','Yukon','Canada','W3I 0B7'),
	(3723682,'372 Husky Street','Anchorage','Alaska','USA','99504'),
	(2412724,'500 Alpine Road','Kelowna','British Columbia','Canada','Y0I 4M3');


INSERT INTO hotel(hotel_id,owner_name, star_rating, number_of_rooms, phone_number, email_address)
VALUES
...
INSERT INTO room(hotel_id, room_number, capacity, isExtendable, outdoor_view, price, problems, amenities,isAvailable)
VALUES
...
FROM check_in
JOIN room ON check_in.room_id = room.room_id
